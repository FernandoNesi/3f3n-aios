  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-10">
      <header className="mb-8 flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold text-white">Dashboard 3F3N · AI</h1>
          <p className="mt-1 text-sm text-muted">
            Últimos {days} {days === 1 ? 'dia' : 'dias'} · insights automáticos
          </p>
        </div>
      ...
      <footer className="mt-10 text-center text-xs text-muted">
        3F3N AI OS · dashboard-3f3n-ai · insights via OpenAI
      </footer>
    </main>
  );
}
